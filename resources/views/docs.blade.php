...
<html lang="en">
  ...
  <section id="home">
      <div class="container" style="padding-top: 55px;">
          ...
          <p class="text-justify">If you want to use the API others Programming Language, run this example URL to Postman. Then click on <strong>Code</strong> icon from Postman to see others programming language example. So, let's go to see how to use the Application.</p>
      </div>
  </section>
